---
layout: post  # 使用合适的布局
title: Huawei Challenge Bounty "Spark Award"  # 奖励名称
categories: rewards  # 类别，使用 rewards 以便归档
permalink: https://mp.weixin.qq.com/s/NXFraboslDTdyHaGAFEjFA
order: 3
---

| Challenge Issue       | Challenge Name                                   | Award Type   | Spark Award Issue | Core Team Members                      |
| ---------------------- | ----------------------------------------------- | ------------ | ------------------ | -------------------------------------- |
| Yangtze Campaign Issue 3 | Non-native Bayer Raw Image Noise Analysis and Processing Technology | Value Award   | Issue 73        | Xinlai Kang, Qiannan Huang, Jingyi Zhang, Cheng Meng |
| Yangtze Campaign Issue 1 | Fiber Optic Sensing Data Enhancement Algorithm   | Encouragement Award | Issue 73        | Jun Zhu, Mengyu Li, Cheng Meng         |
